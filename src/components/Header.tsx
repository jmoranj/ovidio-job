...
export default function Header() {
  return (
    <motion.header
      ...
      className="fixed top-0 left-0 right-0 mx-6 md:mx-40 mt-5 z-99 flex items-center justify-between h-16 p-5 bg-white/5 backdrop-blur-md border border-gray-700 shadow-xl shadow-black/10 rounded-xl">
